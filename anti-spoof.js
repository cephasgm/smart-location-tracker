// Anti-spoofing class to detect fake/mocked locations
class AntiSpoof {
    constructor() {
        ...
        console.log('🛡️ AntiSpoof initialized');
    }
    ...
    checkSpeed(location) {
        ...
        if (speed > this.maxSpeed) {
            console.warn(`⚠️ Speed check failed: ${speed.toFixed(2)} m/s`);
            return false;
        }
    ...
    checkAccuracy(location) {
        ...
        if (location.accuracy < 1) {
            console.warn('⚠️ Accuracy too good, possible mock location');
            return false;
        }

        if (location.accuracy > 500) {
            console.warn('⚠️ Accuracy too poor');
            return false;
        }
    ...
    checkTimestamp(location) {
        ...
        if (timeDiff > 300000) {
            console.warn('⚠️ Timestamp too old');
            return false;
        }
